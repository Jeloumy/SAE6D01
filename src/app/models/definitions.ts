...
export interface ERP {
  ...
  accessibilite: {
    ...
    cheminement_ext: {
      ...
      cheminement_ext_pente_degre_difficulte: number | null;
      cheminement_ext_pente_longueur: number | null;
      cheminement_ext_devers: boolean | null;
    ...
    entree: {
      ...
      entree_dispositif_appel_type: string[] | null;
    ...
    accueil: {
      ...
      accueil_personnels: boolean | null;
      accueil_audiodescription_presence: boolean | null;
      accueil_audiodescription: string[] | null;
      accueil_equipements_malentendants_presence: boolean | null;
      accueil_equipements_malentendants: string[] | null;
